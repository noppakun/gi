...
// ---------------------------------------------------------------------
{
    ...
    public function print()
    {
        ...
        $Pdfparam = [
            ...
            'mode' => Pdf::MODE_UTF8,
            'format' => $this->_ifCfg('format', Pdf::FORMAT_A4),
            'orientation' => $this->_ifCfg('orientation', Pdf::ORIENT_PORTRAIT),
            'marginTop' => $this->_ifCfg('marginTop', 3),
            'marginLeft' => $this->_ifCfg('marginLeft', 3),
            'marginRight' => $this->_ifCfg('marginRight', 3),
            'marginBottom' => $this->_ifCfg('marginBottom', 15),
            'content' => $this->_ifCfg('content', '= content ='),
            'cssFile' => '@app/web/css/kv-mpdf-xreport.css',                        
            'cssInline' => $this->_ifCfg('cssInline', ''),
            'options' => [
                'title' => $this->_ifCfg('title', 'xReport'),
                'showWatermarkText' => $this->_ifCfg('SetWatermarkText', false),                
                
            ],
            
            'methods' => [
                //'SetHTMLHeader' => [$this->renderPageHeader()],
                //'SetHTMLHeader' => [($this->pageHeader)()],
                
            
                'SetWatermarkText'=> $this->_ifCfg('SetWatermarkText', null),
                ...
                'SetHeader' => [
                    $this->_ifCfg(
                        'pageHeader',
                        Html::tag('h2', gihelper::comp_name())                        
                    ),
                ],
                'SetFooter' => [
                    $this->_ifCfg('pageFooter', '@ {DATE d-m-Y - H:i:s}'),
                ],
