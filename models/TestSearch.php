...
/**
 * TestSearch represents the model behind the search form of `app\models\Company`.
 */
class TestSearch extends Company
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'LockTransactionDate' => $this->LockTransactionDate,
        ]);
