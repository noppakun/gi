    ...
    <div class="panel  panel-primary">
        ...
        <div class="table-responsive" id="table_detail">
            <table class="table">
                ...
                <tbody>
                    <template>
                        <tr v-if="item.rec_status!=='d'" v-for="(item, index)  in displayedItems" :item-id="item.id">
                        <template>
                        </template>
                            <template>
...
$this->registerJsFile("https://unpkg.com/vuejs-paginate@latest", ['position' => $this::POS_END]);
