...
<div id="app">
    ...
    <div class="panel  panel-primary">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">รายละเอียด</div>
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="row">
                    <div class="col-xs-2 col-md-2">ราคาต่อหน่วย</div>
                    <div class="col-xs-2 col-md-2">จำนวน</div>
                    <div class="col-xs-2 col-md-2">หน่วย</div>
                    <div class="col-xs-2 col-md-2">รวม</div>
                    <div class="col-xs-2 col-md-2">หมายเหตุ</div>
                    <div class="col-xs-2 col-md-2">action</div>
                </div>
            </div>
        </div>
        <div class="row" v-for="(item, index)  in displayedItems">
            <template v-if="item.rec_status!=='d'">
                <div class="col-xs-12 col-sm-6 col-md-6">{{item.item_desc}}</div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="row">
                        <div class="col-xs-2 col-md-2">{{item.price| numeral('0,0.00') }}</div>
                        <div class="col-xs-2 col-md-2">{{item.qty| numeral('0,0.00') }}</div>
                        <div class="col-xs-2 col-md-2">{{item.uom}}</div>
                        <div class="col-xs-2 col-md-2">{{item.qty*item.price| numeral('0,0.00') }}</div>
                        <div class="col-xs-2 col-md-2">{{item.remark}}</div>
                        <div class="col-xs-2 col-md-2" style=<?= ($model->review_user == null) ? "" : "display:none" ?>>
    ...
    <div class="table-responsive" id="table_detail">
        <table class="table">
            <thead>
                <tr>
                    <!-- <th>Id</th> -->
                    <th width='50%' class="col-xs-6 col-md-4">รายละเอียด</th>
                    <th>ราคาต่อหน่วย</th>
                    <th>จำนวน</th>
                    <th>หน่วย</th>
                    <th>รวม</th>
